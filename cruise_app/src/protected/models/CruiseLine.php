...
/**
 * This is the model class for table "cruise_lines".
 *
 * The followings are the available columns in table 'cruise_lines':
 * @property integer $id
 ...
 */
class CruiseLine extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'ships' => array(self::HAS_MANY, 'Ships', 'cruise_id'),
		);
	}
	 ...
	 * @return CruiseLine the static model class
	 */
